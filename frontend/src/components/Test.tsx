  ...
  return (
    <>
      <div className="gradientBackground">
        <Navbar />
        <div className=" flex flex-col md:flex-row justify-center md:px-[100px] px-[20px] pt-7 ">
          <div className="md:h-[25rem] md:w-1/2 border-red-500 border-2 flex flex-col gap-4 items-center justify-center px-10">
